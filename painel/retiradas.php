...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="scroll-x">
        <table>
            <tr><th>Data/Hora</th><th>Tipo</th><th>Agrupamento</th><th>Esquadrão</th><th>Status</th><th>Protocolo</th><th></th></tr>
            <?php foreach ($retiradas as $r): ?>
                <tr>
                    ...
                    <td><a href="retirada_marcar.php?id=<?= $r['id'] ?>" class="link-btn"><?= $r['status'] === 'pendente' ? 'continuar chamada' : 'ver' ?></a></td>
                </tr>
            <?php endforeach; ?>
        </table>
        </div>
