...
<title>Ikarus37 — <?= htmlspecialchars($grupo['nome']) ?></title>
<style>
...
<div class="topbar">
    <div class="brand">IKARUS37 <a href="dominio.php?entidade=grupos_acesso"><span class="i" style="--icon-url:url('../images/icons/arrow-left.svg')"></span>domínio</a></div>
