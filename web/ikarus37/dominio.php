...
if (!temPermissao($conexao, 'ikarus37', $_SESSION['admin_nivel'], 'gerenciar_dominio')) {
    exibirAcessoNegado("Sua conta não tem a permissão 'gerenciar_dominio'.");
}
...
<div class="container">
    ...
    <?php if ($chaveEntidade === 'grupos_acesso'): ?>
        <p style="color: var(--text-muted); font-size: 13px;">
            ...
            Se o que você precisa é dar/tirar permissão de um cargo que já existe, isso é na aba <a href="?entidade=cargos" style="color:var(--accent);">Cargos</a>, não aqui.
        </p>
    <?php endif; ?>
            ...
            <?php foreach ($registros as $r): ?>
                ...
                <tr class="<?= $estaInativo ? 'inativo' : '' ?>">
                    <?php foreach ($entidade['campos'] as $i => $campo): ?>
                        <td>
                            <?php dominioCampoInputIkarus($campo, $r[$campo['nome']] ?? null, $formId, $unidadesDisponiveis); ?>
